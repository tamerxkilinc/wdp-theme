	...
	<?php else : ?>
		<div class="variations row no-gutters">
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<div class="col-12">
						<div class="label"><label class="text-uppercase text-dark" for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo wc_attribute_label( $attribute_name ); ?></label></div>
					</div>
					<div class="col-12">
						<div class="value text-dark text-uppercase">
							<?php
								...
								echo end( $attribute_keys ) === $attribute_name ? apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations text-uppercase" href="#">' . esc_html__( 'Clear', 'woocommerce' ) . '</a>' ) : '';
							?>
						</div>
					</div>
				<?php endforeach;?>
