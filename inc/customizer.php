...
*/
   ...
   $wp_customize->add_section(
    ...
    $wp_customize->add_control(
		'entry_text',
		array(
			'label'      => __( 'Porsche Entry Text', 'wp-bootstrap-starter' ),
			'description' => __('Text HTML allowed.', 'wp-bootstrap-starter'),
			'type' => 'text',
...
function wp_bootstrap_starter_customizer_css()
{
    ...
    <style type="text/css">
		...
		#footer-widget, #footer-widget a, #footer-widget p, #footer-widget li, #footer-widget i, #footer-widget tr, #footer-widget td, #footer-widget th, #footer-widget table a, #footer-widget .widget-title { color: <?php echo get_theme_mod('footer_widgets_color','#2b2b2b'); ?>!important;}
